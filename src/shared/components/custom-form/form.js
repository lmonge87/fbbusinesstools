...
export default function InputForm(props) {
  ...
  const dataRoutes = {
    ...
    images: `https://graph.facebook.com/v10.0/${userInput}/adimages?fields=${searchFields}&limit=1000&access_token=${accessToken}`,
    campaigns: `https://graph.facebook.com/v10.0/${userInput}/campaigns?fields=${searchFields}&limit=1000&access_token=${accessToken}`,
  };
